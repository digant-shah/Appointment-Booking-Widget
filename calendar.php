      ...
      <div class="header-inner">
		 ...
		 <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown" id="header_notification_bar">
               <a href="changepwd.php" class="dropdown-toggle" >
               Change Password
               </a>
</li>
<li class="dropdown" id="header_notification_bar">
            ...
            <div class="col-md-12">
               <div class="portlet box green">
                           ...
                           <div class="portlet-body form">
                              <!-- BEGIN FORM-->
                              <form action="timeloop.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <b><u>End Time</u></b>
								 ...
								 <?php 
								$cid = $_GET['id'];
								$query = mysql_query("SELECT * from calendar_settings WHERE day_id = 1 and client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
								<input type="text" name="cid" id="cid" value="<?php echo $cid; ?>" style="display:none;">
									<div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="m1" name="m1" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="m2" name="m2" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="m1" name="m1" readonly="" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="m2" name="m2" readonly="" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
								 
                                 </label>
                                 <label class="checkbox-inline">
                                 <input type="checkbox" id="m3" name="m3" checked="checked" value="option1"> Block
                                 </label> <?php } } ?>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                               <div class="checkbox-list">
											   <?php 
								$query = mysql_query("SELECT * from calendar_settings WHERE day_id = 2 and client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="t1" name="t1" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="t2" name="t2" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="t1" name="t1" readonly="" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="t2" name="t2" readonly="" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
								 
                                 </label>
                                 <label class="checkbox-inline">
                                 <input type="checkbox" id="t3" name="t3" checked="checked" value="option1"> Block
                                 </label> <?php } } ?>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                               <div class="checkbox-list">
                                 <?php 
								$query = mysql_query("SELECT * from calendar_settings WHERE day_id = 3 and client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="w1" name="w1" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="w2" name="w2" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="w1" name="w1" readonly="" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="w2" name="w2" readonly="" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
								 
                                 </label>
                                 <label class="checkbox-inline">
                                 <input type="checkbox" id="w3" name="w3" checked="checked" value="option1"> Block
                                 </label> <?php } } ?>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
                                               <div class="checkbox-list">
                                 <?php 
								$query = mysql_query("SELECT * from calendar_settings WHERE day_id = 4 and client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="th1" name="th1" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="th2" name="th2" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="th1" name="th1" readonly="" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="th2" name="th2" readonly="" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
								 
                                 </label>
                                 <label class="checkbox-inline">
                                 <input type="checkbox" id="th3" name="th3" checked="checked" value="option1"> Block
                                 </label> <?php } } ?>
								...
								<?php 
								$query = mysql_query("SELECT * from calendar_settings WHERE day_id = 5 and client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="f1" name="f1" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="f2" name="f2" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="f1" name="f1" readonly="" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="f2" name="f2" readonly="" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
								 
                                 </label>
                                 <label class="checkbox-inline">
                                 <input type="checkbox" id="f3" name="f3" checked="checked" value="option1"> Block
                                 </label> <?php } } ?>
								...
								<?php 
								$query = mysql_query("SELECT * from calendar_settings WHERE day_id = 6 and client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="s1" name="s1" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="s2" name="s2" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="s1" name="s1" readonly="" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="s2" name="s2" readonly="" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
								 
                                 </label>
                                 <label class="checkbox-inline">
                                 <input type="checkbox" id="s3" name="s3" checked="checked" value="option1"> Block
                                 </label> <?php } } ?>
								...
								<?php 
								$query = mysql_query("SELECT * from calendar_settings WHERE day_id = 0 and client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="su1" name="su1" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="su2" name="su2" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
                        ...
                        <input type="text" class="form-control timepicker-default input-small" id="su1" name="su1" readonly="" value="<?php echo date('h:i A',strtotime($row['start_time'])); ?>">
                                 </label>
								 <label class="checkbox-inline">
                         <input type="text" class="form-control timepicker-default input-small" id="su2" name="su2" readonly="" value="<?php echo date('h:i A',strtotime($row['end_time'])); ?>">
								 
                                 </label>
                                 <label class="checkbox-inline">
                                 <input type="checkbox" id="su3" name="su3" checked="checked" value="option1"> Block
                                 </label> <?php } } ?>
								...
								while($row = mysql_fetch_array($query))
								{ ?>
								<option><?php echo $row['time_slot_hr']; }?></option>
								 <option>0</option>
								 <option>1</option>
								 <option>2</option>
								 <option>3</option>
								...
								while($row = mysql_fetch_array($query))
								{ ?>
								<option><?php echo $row['time_slot_min']; }?></option>
								 <option>30</option>
								 <option>45</option>
								 <option>15</option>
								 <option>0</option>
								...
								while($row = mysql_fetch_array($query))
								{ ?>
								<option><?php echo $row['timezone']; }?></option>
									  ...
									  <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
											<?php 
								$query = $query = mysql_query("SELECT * from calendar_setting1 WHERE client_id = '$cid'");
								while($row = mysql_fetch_array($query))
								{
								?>
											  <input type="text" class="form-control" id="r_url" name="r_url" value="<?php echo $row['redirect_url']; ?>">
											 </div>
									      </div>
										   </div>
										   </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                <textarea name="thanku" class="form-control"><?php echo $row['thanku_message']; ?></textarea>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                 <input type="text" class="form-control" id="z_key" name="z_key" value="<?php echo $row['z_key'];  ?>">
                                                <span class="help-block"></span>
                                             </div>
                                          </div>
                                       </div>
									   <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                 <button type="button" id="sync">Sync Events </button>
                                                <span class="help-block"></span>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label class="control-label col-md-3">Widget Code</label>
                                             <div class="col-md-9">
                                                <?php  $a = "<iframe src=".'http://crmshop.ca/demo/widget.php?key='.$row['z_key'].' height="650" width="790" scrolling="no" frameborder="0"></iframe>'; ?>
							
                            <textarea  disabled="disabled" class="form-control" style="cursor:text;height:77px;width:100%;"><?php echo $a; ?></textarea> 
                                             </div>
                                          </div>
                                       </div>
									   </div>
								...
								<div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <span class="help-block">Please select image in 200x200px</span>
                                             </div>
                                          </div>
                                       </div>
									    <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                <img class="avatar" src="uploads/<?php echo $row['img'];?>">
												<input type="hidden" name="img1" value="<?php echo $row['img'];?>">
                                                <span class="help-block"></span>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                 <input type="color" class="form-control" id="cname" name="namecol" value="<?php echo $row['namecol'];  ?>" >
                                                <span class="help-block"></span>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-6">
                                                 <input type="text" class="form-control" id="cname" name="cname2" value="<?php echo $row['cname2'];  ?>" >
                                                <span class="help-block"></span>
                                             </div>
                                          </div>
                                       </div>
									   <div class="col-md-4">
                                          <div class="form-group">
                                             <label class="control-label col-md-3">Select Color</label>
                                             <div class="col-md-6">
                                                 <input type="color" class="form-control" id="cname" name="namecol2" value="<?php echo $row['namecol2'];  ?>" >
                                                <span class="help-block"></span>
                                             </div>
                                          </div>
									   </div> 
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label class="control-label col-md-3">Header Color</label>
                                             <div class="col-md-6">
                                                 <input type="color" class="form-control" name="col" value="<?php echo $row['header_color']; } ?>" >
                                                <span class="help-block">Header Background Color</span>
                                             </div>
                                          </div>
                                       </div>
									   </div> 
 ...
 $("#sync").on('click', function() {
		 var cid = $("#cid").val();
		  var z_key = $("#z_key").val();
			...
			$.ajax({
    			type:'POST',
    			data: { cid: cid, z_key: z_key},
    			url:'sync.php',
    			success:function(data) {
      			
				//$("#info").html('<div class="alert alert-success"><strong>Success!</strong> Events Sync Successfull.</div>');
				alert ('Successful');
